import { REQUEST_COMMON_HANDLERS, REQUEST_ENTER_STATE_HANDLERS, REQUEST_HANDLERS, REQUEST_MAKE_CARD_HANDLERS, REQUEST_VALIDATE_HANDLERS, REQUEST_BATTING_HANDLERS, REQUEST_COMPAIR_HANDLERS } from '@/client/js/communication/indianPocker/requestHandlers';
