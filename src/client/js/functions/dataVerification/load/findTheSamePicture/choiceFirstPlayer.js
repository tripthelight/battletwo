...
import sendMakeNicknameList from '@/client/js/views/game/findTheSamePicture/fns/gameState/stateChoiceFirstPlayer/sendMakeNicknameList'
...
export const CHOICE_FIRST_PLAYER_HANDLER = {
  ...
  handleInitialLoad(storageKeys) {
    ...
    // choiceFirstPlayer 단계에서 필요한 data insert 후 다음
    sendMakeNicknameList();
  },
};
