...
export default (_name) => {
  switch (_name) {
    ...
    case 'CPEB':
      ...
      const encryptVal7 = storageMethod("s", "GET_ITEM", encryptKey7);
      const decryptVal7 = encryptVal7 !== null && encryptVal7 !== '' ? dec(encryptVal7) : 0; // coinsPlayerExtBet value number
      return encryptVal7 !== null && decryptVal7 > 0 ? decryptVal7 : 0;
    case 'CE':
      ...
      const encryptVal8 = storageMethod("s", "GET_ITEM", encryptKey8);
    ...
    case 'CEB':
      ...
      const encryptVal9 = storageMethod("s", "GET_ITEM", encryptKey9);
    ...
    case 'CEEB':
      ...
      const encryptVal10 = storageMethod("s", "GET_ITEM", encryptKey10);
