...
export default () => {
  ...
  if (encryptVal1 === null || (encryptVal1 !== null && encryptVal1 === '')) return errorManagement({ errCase: 'sessionStorageLoss', message: 'betState 세션이 없습니다.' });
  ...
  if (encryptVal2 === null || (encryptVal2 !== null && encryptVal2 === '')) return errorManagement({ errCase: 'sessionStorageLoss', message: 'basicBettingState 세션이 없습니다.' });
  const decryptVal2 = X.dec(encryptVal2);

  // 명령
  // console.log('BASIC_BETTING_STATE :: ', BASIC_BETTING_STATE);
  console.log('basicBettingState :: ', encryptVal2);
