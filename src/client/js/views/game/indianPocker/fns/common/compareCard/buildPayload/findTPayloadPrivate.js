...
export default (_hash, _key) => {
  ...
  try {
    switch (_hash) {
      case key(findCharCode([70, 75, 89, 88, 73, 78, 67, 86, 85, 80])): return {mode: 0, recs: [[75, 128, 0]]}; // CARD NUM : 1
      case key(findCharCode([67, 87, 89, 84, 72, 77, 85, 71, 76, 68])): return {mode: 1, recs: [[75, 68, 0],[75, 188, 1]]}; // CARD NUM : 2
      ...
      default: throw {errCase: 'cardNum', message: 'private card T payload value not descryption'};
    }
  } catch (error) {
