...
export default function (n) {
  switch (n) {
    case dec(enc(encryptNumOfStr(_t([101, 101, 101, 119, 119, 119, 119, 119])))): // "eeewwwww" : 0 : lose
      return new TextDecoder().decode(new Uint8Array([108, 111, 115, 101])); // "lose"
    case dec(enc(encryptNumOfStr(_t([101, 101, 101, 119, 119, 119, 119, 98])))): // "eeewwwwb" : 1 : win
