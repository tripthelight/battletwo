...
export const REQUEST_HANDLERS = {
  ...
  requestDoubleReload: (v) => ({ type: 'requestDoubleReload', gameState: v }),
  responseDoubleReload: (v) => ({ type: 'responseDoubleReload', gameState: v }),
  requestRoundResultReloadSync: (v) => ({ type: 'requestRoundResultReloadSync', ...v }),
  responseRoundResultReloadSync: (v) => ({ type: 'responseRoundResultReloadSync', ...v }),
  roundResultStepReady: (v) => ({ type: 'roundResultStepReady', ...v }),
  roundResultStepAck: (v) => ({ type: 'roundResultStepAck', ...v }),
