  ...
  findTheSamePicture: () => {
    return {
      ...
      */
      ...
      // s: sessionStorage keys
      NICKNAME_LIST: {
        k: 'FPSOGWKNLT' // [70, 80, 83, 79, 71, 87, 75, 78, 76, 84]
      },
      CLICK_USER: {
        k: 'KMXHPIVGCN' // [75, 77, 88, 72, 80, 73, 86, 71, 67, 78]
      },
      PN: {
        k: 'KOSNYRDEIV' // [75, 79, 83, 78, 89, 82, 68, 69, 73, 86]
      },
      EN: {
        k: 'PRDIVUZBWG' // [80, 82, 68, 73, 86, 85, 90, 66, 87, 71]
      },
      RNS: {
        k: 'BTXHOIRLUM' // [66, 84, 88, 72, 79, 73, 82, 76, 85, 77]
      },
      GAME_STATE_NEXT: {
      ...
      */
      ...
      // s: sessionStorage keys
      GAME_STATE_GET_ALL: {
        k: 'OUYMHWQNAB' // [79, 85, 89, 77, 72, 87, 81, 78, 65, 66]
      },
      REFRESH: {
        k: 'CEUSBRXVFK' // [67, 69, 85, 83, 66, 82, 88, 86, 70, 75]
      },
      ROUND: {
        k: 'QEDTYWLCHI' // [81, 69, 68, 84, 89, 87, 76, 67, 72, 73]
      },
      PLAYING_RE: {
        k: 'ZAXENYCJLI' // [90, 65, 88, 69, 78, 89, 67, 74, 76, 73]
      },
      RESULT: {
        k: 'CHVDSMJAXN' // [67, 72, 86, 68, 83, 77, 74, 65, 88, 78]
      },
      // e: sessionStorage keys
      */
      // —————————————————————————————————————————————————————————————————————
